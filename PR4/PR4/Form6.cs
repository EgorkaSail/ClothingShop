    ...
    public partial class Form6 : Form
    {
        ...
        private async void Form6_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    listBox1.Items.Add(Convert.ToString(sqlReader["id_ticket"]) + "  " + Convert.ToString(sqlReader["rows_number"]) + "  " + Convert.ToString(sqlReader["place_hall"]) + "  " + Convert.ToString(sqlReader["id_perform"]));
                }
            }
            catch (Exception ex)
            {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command = new SqlCommand("INSERT INTO [Tickets] (rows_number, place_hall, id_perform)VALUES(@rows_number, @place_hall, @id_perform)", sqlConnection);
                command.Parameters.AddWithValue("rows_number", textBox1.Text);
                command.Parameters.AddWithValue("place_hall", textBox2.Text);
                command.Parameters.AddWithValue("id_perform", textBox3.Text);
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command = new SqlCommand("UPDATE [Tickets] SET [rows_number]=@rows_number, [place_hall]=@place_hall, [id_perform]=@id_perfrom WHERE [id_ticket]=@id_ticket", sqlConnection);
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command = new SqlCommand("DELETE FROM [Tickets] WHERE [id_ticket]=@id_ticket", sqlConnection);
                command.Parameters.AddWithValue("id_ticket", textBox8.Text);
