...
namespace PR4
{
    public partial class Form5 : Form
    {
        ...
        private async void Form5_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("SELECT * FROM [Sex]", sqlConnection);
            ...
            try
            {
                ...
                {
                    listBox1.Items.Add(Convert.ToString(sqlReader["id_sex"]) + "  " + Convert.ToString(sqlReader["name_sex"]));
                }
            }
            catch (Exception ex)
            {
